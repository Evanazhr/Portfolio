export default function Skills() {
    return (
        <div className="mb-6 w-full animate-fadeUp overflow-hidden border-b border-secondary-dark pb-6">
            ...
            <div className="flex animate-infinite-slide-r">
                <ul className="my-6 box-border flex max-w-[1200px] -translate-x-[1200px]">
                    ...
                    <li className="animate-scaleUp">
                        <div className="flex w-[200px] scale-90 animate-pulse-2 flex-row items-center justify-center gap-2 rounded-lg px-3 py-2 font-bold shadow-md shadow-light-color">
                            <svg
                                className="W-6 h-6"
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 512 512"
                    ...
                    <li className="animate-scaleUp">
                        <div className="flex w-[200px] scale-90 animate-pulse-3 flex-row items-center justify-center gap-2 rounded-lg px-3 py-2 font-bold shadow-md shadow-light-color">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                className="h-6 w-6"
                    ...
                    <li className="animate-scaleUp">
                        <div className="flex w-[200px] scale-90 animate-pulse-4 flex-row items-center justify-center gap-2 rounded-lg px-3 py-2 font-bold shadow-md shadow-light-color">
                            <svg
                                className="h-6 w-6"
                                viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg"
                    ...
                    <li className="animate-scaleUp">
                        <div className="flex w-[200px] scale-90 animate-pulse-1 flex-row items-center justify-center gap-2 rounded-lg px-3 py-2 font-bold shadow-md shadow-light-color">
                            <svg
                                viewBox="0 0 512 512"
                                fill="currentColor"
                                className="h-6 w-6"
            ...
            <div className="flex animate-infinite-slide-l">
                <ul className="my-6 box-border flex max-w-[1200px]">
                    <li className="animate-scaleUp">
                        <div className="flex w-[200px] scale-90 animate-pulse-1 flex-row items-center justify-center gap-2 rounded-lg p-3 px-3 py-2 font-bold shadow-md shadow-light-color">
                            <svg
                                className="h-6 w-6"
